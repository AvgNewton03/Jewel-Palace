      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link
              href="/"
              className="font-serif text-2xl font-bold text-brand-gold tracking-wider mb-4 block"
            >
              Jewel Palace
            </Link>
            <p className="text-sm text-gray-300 mb-6 leading-relaxed">
              Exquisite imitation jewellery for every occasion. Bringing
              festivity and vibrancy to your style with premium quality pieces.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/jewel_palace_borivali/"
                target="_blank"
