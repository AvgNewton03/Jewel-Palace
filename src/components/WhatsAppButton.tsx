...
export default function WhatsAppButton() {
  ...
  const handleClick = (e: React.MouseEvent) => {
    e.preventDefault();
    requireAuth(() => {
      window.open("https://wa.me/919029923215", "_blank");
    });
  };
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-20 right-6 md:bottom-10 md:right-10 z-[9999] bg-[#25D366] text-white p-4 rounded-2xl shadow-xl hover:shadow-2xl hover:scale-110 hover:-translate-y-1 transition-all duration-300 flex items-center justify-center group border-none"
